            ...
            <div className="main_nav" >
                <div className='nav'>
                    <div className="section_container" >
                        <svg xmlns="http://www.w3.org/2000/svg" className="logo" viewBox="0 0 512 512">
                    ...
                    <h1 className="section_container center_class logo_text" >LOGO</h1>
                    <div className="section_container" style={{justifyContent:'end'}}>
                        <div className="icon-nav">
                            <i className='pi pi-search icons' ></i>
                            <i className='pi pi-heart'></i>
                            <i className="pi pi-shopping-bag"></i>
                            <i className="pi pi-user visible"></i>
                            <span>
                                <select name="eng" className='visible' id="">
                                    <option value="eng" className=''>ENG</option>
                                    <option>MAL</option>
                                </select>
                            </span>
                        </div>
